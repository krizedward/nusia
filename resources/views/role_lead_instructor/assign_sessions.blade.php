    ...
    <div class="col-md-9">
      <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
          @foreach($instructors as $i => $dt)
            <li @if($i == 0) class="active" @endif><a href="#i{{ $i + 1 }}" data-toggle="tab"><b>[{{ $i + 1 }}] {{ $dt->user->first_name }} {{ $dt->user->last_name }}</b></a></li>
          @endforeach
        </ul>
        <div class="tab-content">
          
          @foreach($instructors as $i => $instructor)
          <div class="@if($i == 0) active @endif tab-pane" id="i{{ $i + 1 }}">
            <div class="row">
                    ...
                    <div class="box-body">
                      ...
                      <table class="table table-bordered table-striped example1">
                        ...
                        <tbody>
                          ...
                          @if(count($instructor_schedules) != 0 && isset($instructor_schedule_arrs[$instructor->id]))
                            @foreach($instructor_schedule_arrs[$instructor->id] as $dt)
                    ...
                    <div class="box box-default">
                      ...
                      <div class="box-body">
                        ...
                        <table class="table table-bordered table-striped example1">
                          ...
                          <tbody>
                            @if(count($course_by_instructor_arrs) != 0 && isset($course_by_instructor_arrs[$instructor->id]))
                              @foreach($course_by_instructor_arrs[$instructor->id] as $dt)
