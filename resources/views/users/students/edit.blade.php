  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-warning">
        ...
        <form role="form" method="post" action="{{ route('students.update', $data->id) }}" enctype="multipart/form-data">
          @csrf
          @method('PUT')
          <div class="box-body">
            <div class="row">
              <div class="col-md-6">
                <div class="col-md-6">
                  ...
                  @endif
                      ...
                      <input name="email" type="email" class="@error('email') is-invalid @enderror form-control" placeholder="Enter Email" value="{{ $data->user->email }}">
                      @error('email')
                ...
                <div class="col-md-6">
                  ...
                  @endif
                      ...
                      <input name="first_name" type="text" class="@error('first_name') is-invalid @enderror form-control" placeholder="Enter First Name" value="{{ $data->user->first_name }}">
                      @error('first_name')
                        <p style="color:red">{{ $message }}</p>
                      @enderror
                    </div>
                ...
                <div class="col-md-6">
                  ...
                  @endif
                      ...
                      <input name="last_name" type="text" class="@error('last_name') is-invalid @enderror form-control" placeholder="Enter Last Name" value="{{ $data->user->last_name }}">
                      @error('last_name')
                        <p style="color:red">{{ $message }}</p>
                      @enderror
                    </div>
                ...
                <div class="col-md-6">
                  ...
                  @endif
                      ...
                      <select name="status_job" type="text" class="@error('status_job') is-invalid @enderror form-control" id="status_job" onChange="if(document.getElementById('status_job').value == 'Student') {document.getElementById('status_description_label').innerHTML = 'School / University Name'; document.getElementById('status_description').className = 'form-group';} else if(document.getElementById('status_job').value == 'Professional') {document.getElementById('status_description_label').innerHTML = 'Working Place'; document.getElementById('status_description').className = 'form-group';} else {document.getElementById('status_description_label').innerHTML = 'School / University / Working Place'; document.getElementById('status_description').className = 'form-group hidden';}">
                        <option value="">-- Enter Job Status --</option>
                ...
                <div class="col-md-6">
                  ...
                  @else
                    @if($data->status_description)
                      <div class="form-group" id="status_description">
                    @else
                      <div class="form-group hidden" id="status_description">
                    @endif
                  @endif
                    @if($data->status_job == 'Student')
                      <label for="status_description" id="status_description_label">School / University Name</label>
                    @elseif($data->status_job == 'Professional')
                      <label for="status_description" id="status_description_label">Working Place</label>
                    @else
                      <label for="status_description" id="status_description_label">School / University / Working Place</label>
                    @endif
                      <input name="status_description" type="text" class="@error('status_description') is-invalid @enderror form-control" placeholder="Enter Value" id="status_description_input" value="{{ $data->status_description }}">
              ...
              <div class="col-md-6">
                <div class="col-md-12">
                  ...
                  @endif
                      ...
                      <input name="age" type="text" class="@error('age') is-invalid @enderror form-control" placeholder="Enter Age" value="{{ $data->age }}">
                      @error('age')
                        <p style="color:red">{{ $message }}</p>
                      @enderror
                    </div>
                  ...
                  @endif
                      ...
                      <select name="citizenship" type="text" class="@error('citizenship') is-invalid @enderror form-control">
                        ...
                        @foreach($countries as $country)
                          @if($data->user->citizenship == $country)
