...
@section('content')
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><b>Complete Payment Information</b></h3>
                    </div>
                    <form role="form" method="post" action="{{ route('student.store_payment_information', $new_course_package_id) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6">
