...
Route::group(['middleware'=>'auth'], function() {
        ...
        Route::get('/placement-tests/{id}', 'PlacementTestController@show')->name('placement_tests.index'); // View ini digunakan untuk melihat informasi detail placement test untuk setiap Student.
