...
Route::group(['middleware'=>'auth'], function() {
        ...
        // for role Student
        Route::get('/student/choose-materials', 'HomeController@choose_materials')->name('student.choose_materials'); // View ini digunakan untuk memilih jenis course package.
        Route::post('/student/choose-materials', 'HomeController@store_materials')->name('student.store_materials'); // Mengumpulkan informasi. Daftar model dibuat: Course, CourseRegistration.
