...
Route::group(['middleware'=>'auth'], function() {
        ...
        Route::post('/student/complete-payment-information/course/{id}', 'HomeController@store_payment_information')->name('student.store_payment_information'); // Mengumpulkan informasi. Daftar model dibuat: CourseRegistration, CoursePayment.
