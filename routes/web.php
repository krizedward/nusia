...
Route::group(['middleware'=>'auth'], function() {
        ...
        Route::get('/student/complete-payment-information/{id}', 'HomeController@complete_payment_information')->name('student.complete_payment_information'); // ID digunakan adalah course_package_id yang kemudian diubah menjadi ID 1 course package "sementara". Apabila Student belum dipindahkan ke course tertentu, maka akan ditambahkan ke course ini, sampai Lead Instructor mengonfirmasi hasil placement test. View ini digunakan untuk mengisi informasi pembayaran.
        Route::post('/student/complete-payment-information/{id}', 'HomeController@store_payment_information')->name('student.store_payment_information'); // Mengumpulkan informasi. Daftar model dibuat: CourseRegistration, CoursePayment.
        Route::get('/student/complete-placement-tests/{id}', 'HomeController@complete_placement_tests')->name('student.complete_placement_tests'); // ID digunakan adalah course_registration_id. View ini berisi informasi placement test. Student bisa logout, kemudian pada waktu login kembali, jika sudah pernah masuk dashboard, maka ada 1 opsi sidebar untuk melihat daftar placement test dan mengumpulkan video placement test. Jika Student belum pernah mendaftar sebelumnya, maka setelah login, Student langsung diarahkan ke tampilan ini untuk mengumpulkan hasil placement test.
