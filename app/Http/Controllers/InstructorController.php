...
class InstructorController extends Controller
{
    ...
    public function session_reschedule_update(Request $request) {
        ...
        if($session->requirement && $session->reschedule_technical_issue_student == -1) {
            session(['caption-danger' => 'Cannot reschedule, please firstly accept or decline a reschedule request from your student for this session.']);
            return redirect()->back()->withInput();
        }
